...
If the concept you need isn't in the glossary yet, that's a signal: either you're inventing language the project doesn't use, or there's a real documentation gap to resolve with `/grill-with-docs`.
